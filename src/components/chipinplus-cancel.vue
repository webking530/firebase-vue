    ...
    >
      ...
      <b-row>
        <b-col md="6" offset-md="3" class="mb-3">
          ...
          <p class="font-weight-light mb-1 mt-0 text-center">
            Payment Cancelled. <br />
            Baby, one more time?
          </p>

          <p class="text-center mt-5 pt-52">
            <b-button
...
export default {
  ...
  methods: {
    hideModal() {
      this.$refs["chipinplus-cancel"].hide();
    },
  },
  mounted() {
    this.$refs["chipinplus-cancel"].show();
  },
};
</script>
