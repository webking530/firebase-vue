      ...
      <b-col cols="10" offset="1" sm="8" offset-sm="2" md="8" offset-md="2">
        ...
        <b-card class="my-3 pb-2 shadow-sm bg-dark text-left" no-body>
          <b-card-body>
            ...
            <p class="mt-4 text-light text-birth text-left">
              Finally, please type your <b>birthdate</b>
            </p>

            <b-form  @submit.stop.prevent="onSubmit">
              <p
                class="mt-4 text-cool pr-5"
                style="color:#E76E66"
              >
                Oops! Im afraid your too young to create an account. Please ask a parent or guardian.
              </p>
