<template>
  <div>
    ...
    <b-container v-if="loaded" class="mb-5">
        ...
        <SettingsTitle v-bind:title="'Transactions'"></SettingsTitle>
        
        <b-row class="mt-3">
          <SectionHeading v-bind:name="'Transactions'"></SectionHeading>
...
export default {
  ...
  methods: {
    ...mapActions("Chipinmanager", { api_subscriptions: "transactions" }),
  },
  beforeMount() {
